...
- When planning storyline or editorial tone for THP-branded content, read strategy from `~/Desktop/The-Hard-Port-stuff/The Hard Port/the-hard-port-os/` — do not duplicate those docs here.
...
- Always consult platform skills (`skills/youtube_chunks/`, `skills/youtube_shorts/`, etc.) before making cut decisions.
